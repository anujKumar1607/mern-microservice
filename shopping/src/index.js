...
const { registerService, deregisterService } = require('./utils');

const os = require('os');
const { v4: uuidv4 } = require('uuid');
const CONSUL_HOST = process.env.CONSUL_HOST || 'consul';
const CONSUL_PORT = process.env.CONSUL_PORT || 8500;
const SERVICE_NAME = 'shopping';
const SERVICE_ID = `${SERVICE_NAME}-${uuidv4()}`;
const SERVICE_ADDRESS = 'shopping'; // in Docker network the container name resolves; otherwise use host IP
