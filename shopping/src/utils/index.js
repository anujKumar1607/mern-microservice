...
module.exports.registerService = async(opts) => {
...
module.exports.deregisterService = async(id, consulHost = 'localhost', consulPort = 8500) => {
...
module.exports.discoverServiceInstances = async(serviceName, consulHost = 'localhost', consulPort = 8500) => {
